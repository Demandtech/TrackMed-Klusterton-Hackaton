...
import { MobileAside, MobileNav, WebNav } from "../components/reusables";
...
const Home = () => {
  ...
  return (
    <>
      <div className="  w-screen bg-hero bg-cover bg-green-200 bg-center">
            ...
            <div className="pt-10 lg:pt-20 m-auto">
              ...
              <div className="grid max-md:grid-cols-1 min-[768px]:grid-cols-2 lg:grid-cols-3 gap-3 px-5 mb-5">
                ...
                <div className=" ">
                  ...
                  <ul className="">
                    <li className="max-md:text-xs text-white font-poppins text-center italic ">
                      Allow users to input their medication details, including
                      the name of the drug, dosage, frequency, and the specific
